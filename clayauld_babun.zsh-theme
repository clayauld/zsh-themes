...
if [ "$DAVE_RPROMPT_TIME" = "" ]; then
  DAVE_RPROMPT_TIME=%D{%I:%M:%S\ %p}
fi
if [ "$DAVE_RPROMPT_DATE" = "" ]; then
  DAVE_RPROMPT_DATE=%D{%m-%d-%Y}
fi
...
#
#  DAVE COLOR PALETTE: Google
#
DAVE_COLOR_HOST_BG='004'
DAVE_COLOR_HOST_FG='255'

DAVE_COLOR_USER_BG='160'
DAVE_COLOR_USER_FG='255'

DAVE_COLOR_DIR_BG='214'
DAVE_COLOR_DIR_FG='000'

DAVE_COLOR_GIT_BG='028'
DAVE_COLOR_GIT_FG='255'
DAVE_COLOR_GIT_CLEAN='255'
DAVE_COLOR_GIT_DIRTY='000'

DAVE_SHOW_DATE='NO'
DAVE_COLOR_DATE_BG='255'
DAVE_COLOR_DATE_FG='059'

DAVE_SHOW_TIME='YES'
DAVE_COLOR_TIME_BG='059'
DAVE_COLOR_TIME_FG='255'

DAVE_NO_BLANK_LINE=''
DAVE_COLOR_END_BG='234'
